...
@Configuration
@EnableSwagger2
@ComponentScan(basePackages = {"com.crosslab"})
public class SwaggerConfig extends WebMvcConfigurerAdapter {
	...
	public Docket customDocket() {
		...
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.crosslab.blockchain.core.controller"))
	...
	private ApiInfo apiInfo() {
		Contact contact = new Contact("crosslab", "", "crosslab@qq.com");
