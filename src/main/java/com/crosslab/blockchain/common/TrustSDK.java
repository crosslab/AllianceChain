...
import com.crosslab.blockchain.common.algorithm.ECDSAAlgorithm;
import com.crosslab.blockchain.common.exception.ErrorNum;
...
public class TrustSDK {
	 ...
	 * @since JDK 1.7
	 */
	public static YLPairKey generatePairKey() throws TrustSDKException {
	 ...
	 * @since JDK 1.7
	 */
	public static YLPairKey generatePairKey(boolean encodePubKey) throws TrustSDKException {
		try {
			YLPairKey pair = new YLPairKey();
